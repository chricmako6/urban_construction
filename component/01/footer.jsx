      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8 lg:px-10 p-10">
        ...
        >
          ...
          <motion.div variants={fadeUp}>
            ...
            <p className="text-gray-400 text-xs sm:text-sm md:text-base leading-relaxed max-w-md">
              From project planning to final touches, we offer our clients share
          ...
          {/* Contact */}
          <motion.div variants={fadeUp}>
            <h4 className="font-bold text-base sm:text-lg md:text-xl mb-4 sm:mb-6">
              Contact
            </h4>
              ...
              {[
                {
                  ...
                  text: "1050 Brisbane Ave, US",
                },
                { icon: <MdOutlinePhoneIphone />, text: "+1(888)000-0000" },
                {
                  icon: <MdOutlineMailOutline />,
                  text: "email@urbanbuild.com",
                },
              ].map((item, i) => (
                <motion.div
                  key={i}
          ...
          {/* Newsletter */}
          <motion.div variants={fadeUp}>
            <h4 className="font-bold text-base sm:text-lg md:text-xl mb-3 sm:mb-4">
              Newsletter
            </h4>

            <p className="text-gray-400 text-xs sm:text-sm md:text-base mb-3 sm:mb-4">
              Enter your email to commercial receipt our clients share their
        ...
        >
          ...
          <div className="flex gap-4 sm:gap-6">
            {[FaFacebookF, FaXTwitter, MdOutlineMailOutline, IoLogoYoutube].map(
              (Icon, i) => (
                <motion.div
                  key={i}

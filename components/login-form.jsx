            ...
            <FieldGroup>
              ...
              {isSignUp && (
                <>
                  <Field>
                    ...
                    <Input id="name" type="text" placeholder="Chris Mac" required />
                  </Field>
                  <Field>
              ...
              <Field>
                <div className="flex items-center">
                  ...
                  {!isSignUp && (
                    <a href="#" className="ml-auto text-sm underline-offset-2 hover:text-[#f5c84a]">
              ...
              <Field>
                <Button type="submit" className="bg-[#ffbf00] hover:bg-[#f5c84a] cursor-pointer text-black">
                ...
                {isSignUp ? (
                  <>
                    ...
                    <button 
                      ...
                      className="hover:text-[#f5c84a] focus:outline-none"
                    >
                      Login
                    </button>
                  </>

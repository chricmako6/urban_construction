  ...
  return (
    <div className="max-w-full">
      ...
      >
        ...
        {/* NAV DOTS → PROFESSIONAL BREADCRUMB */}
        <motion.div
        ...
        >
          <div className="flex items-center gap-2 text-sm text-white/80">
            ...
            <Link
              href="/shop"
              className="hover:text-[#ffd061] transition-colors duration-300"
            >
              Shop
            </Link>
            ...
            {/* CURRENT */}
            <span className="text-[#ffd061] font-semibold">Map Shop</span>
          </div>
        </motion.div>
      ...
      >
        ...
        >
          Explore our collection of modern house plans, designed to inspire your
          next architectural project. Whether you're looking for a sleek urban
          design or a spacious family home, our curated selection offers a
          variety of styles and layouts to suit your needs.
        </motion.p>
      </motion.div>
      ...
      <div
        ...
        className="bg-[#ffd061] hover:bg-[#f5c84a] shadow-2xl rounded-full p-2.5 cursor-pointer fixed z-100 bottom-6 right-6"
      >

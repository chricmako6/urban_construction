...
function Aboutsession4() {
  ...
  return (
    <div className='flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8'>
      ...
      {/* Team Members Grid */}
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 md:gap-8 mx-auto max-w-5xl w-full mb-20'>
        ...
        {teamMembers.map((member) => (
          <div key={member.id} className='group relative flex flex-col items-center'>
            ...
            {/* Floating Card */}
            <div className='absolute bottom-0 md:-bottom-6 left-1/2 transform -translate-x-1/2 -translate-y-0 md:translate-y-0 w-11/12 md:w-5/6 bg-[#383635]/90 backdrop-blur-lg border border-white/20 rounded-xl p-3 md:p-4 shadow-2xl shadow-black/20'>

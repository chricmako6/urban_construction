  ...
  return (
    <div className='pt-24 w-full h-screen bg-cover bg-center relative flex items-center'
        ...
        <div className='gap-4 p-10 md:p-0 top-1/2 -translate-y-1/2 absolute'>
            ...
            className='group md:ml-52 mt-6'>
                <button className='group/btn bg-[#ffd061] hover:bg-[#f5c84a] shadow cursor-pointer text-black flex items-center gap-3 px-5 py-2 rounded-md font-semibold'>
                    SEE OUR WORKS

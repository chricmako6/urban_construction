  ...
  return (
    <div className="w-full">
      ...
      >
        ...
        >
          <div className="flex items-center gap-2 text-sm text-white/80">
            ...
            {/* CURRENT */}
            <span className="text-[#ffd061] font-semibold">About Us</span>
          </div>
        </motion.div>
      ...
      <div
        ...
        className="bg-[#ffd061] hover:bg-[#f5c84a] shadow-2xl rounded-full p-2.5 cursor-pointer fixed z-100 right-6 bottom-6"
      >

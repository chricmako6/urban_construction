    ...
    <div id='about' className='w-full mt-25 mb-25 md:mt-20 md:mb-20 gap-4 sm:gap-6 h-auto grid grid-cols-1 md:grid-cols-2 items-center px-4 sm:px-6 md:px-0'>
        <div className=''>
             <motion.h1 
                ...
                className='md:ml-52 mx-auto text-[10px] sm:text-[12px] md:text-[15px] gap-2 text-[#5e5f61] font-bold md:my-5 my-3 flex items-center justify-center md:justify-start'
            >
            ...
            >
                <h1 className='ml-0 sm:ml-20 md:ml-52 text-[10px] sm:text-[12px] md:text-[15px] gap-2 text-[#5e5f61] font-bold md:my-5 my-3 flex items-center justify-center md:justify-start'>
                Signature
                </h1>
            </motion.div>

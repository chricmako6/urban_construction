...
function Counting() {
  return (
    <div className='w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 bg-[#383635] py-5 sm:py-8 md:py-5 gap-3 sm:gap-4 md:gap-3 px-4 sm:px-6 md:px-0 mx-auto'>
